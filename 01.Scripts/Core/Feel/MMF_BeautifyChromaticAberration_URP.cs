...
namespace MoreMountains.FeedbacksForThirdParty
{
    ...
    [FeedbackHelp(
        "This feedback allows you to control chromatic aberration intensity over time. It requires you have in your scene an object with a Volume " +
        "with Chromatic Aberration active, and a MMBeautifyChromaticAberrationShaker_URP component.")]
    [FeedbackPath("PostProcess/Beautify Chromatic Aberration URP")]
    [MovedFrom(false, null, "MoreMountains.Feedbacks.URP")]
    public class MMF_BeautifyChromaticAberration_URP : MMF_Feedback
    {
        ...
        protected override void CustomPlayFeedback(Vector3 position, float feedbacksIntensity = 1.0f)
        {
            ...
            MMBeautifyChromaticAberrationShakeEvent_URP.Trigger(Intensity, FeedbackDuration, RemapIntensityZero,
                RemapIntensityOne, RelativeIntensity, intensityMultiplier,
        ...
        protected override void CustomStopFeedback(Vector3 position, float feedbacksIntensity = 1)
        {
            ...
            MMBeautifyChromaticAberrationShakeEvent_URP.Trigger(Intensity, FeedbackDuration, RemapIntensityZero,
                RemapIntensityOne, RelativeIntensity, channelData: ChannelData, stop: true);
        }
        ...
        protected override void CustomRestoreInitialValues()
        {
            ...
            MMBeautifyChromaticAberrationShakeEvent_URP.Trigger(Intensity, FeedbackDuration, RemapIntensityZero,
                RemapIntensityOne, RelativeIntensity, channelData: ChannelData, restore: true);
        }
    }
}