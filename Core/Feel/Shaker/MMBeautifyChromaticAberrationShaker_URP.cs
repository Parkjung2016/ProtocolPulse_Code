...
namespace MoreMountains.FeedbacksForThirdParty
{
    ...
    [AddComponentMenu("More Mountains/Feedbacks/Shakers/PostProcessing/MMBeautifyChromaticAberrationShaker_URP")]
    public class MMBeautifyChromaticAberrationShaker_URP : MMShaker
    {
        ...
        protected override void Shake()
        {
            float newValue = ShakeFloat(ShakeIntensity, RemapIntensityZero, RemapIntensityOne, RelativeIntensity,
                _initialIntensity);
            _beautify.chromaticAberrationIntensity.Override(newValue);
        }
        ...
        {
            _initialIntensity = _beautify.chromaticAberrationIntensity.value;
        }
        ...
        public virtual void OnMMChromaticAberrationShakeEvent(AnimationCurve intensity, float duration, float remapMin,
        ...
        protected override void ResetTargetValues()
        {
            ...
            _beautify.chromaticAberrationIntensity.Override(_initialIntensity);
        }
        ...
        {
            base.StartListening();
            MMBeautifyChromaticAberrationShakeEvent_URP.Register(OnMMChromaticAberrationShakeEvent);
        }
        ...
        {
            base.StopListening();
            MMBeautifyChromaticAberrationShakeEvent_URP.Unregister(OnMMChromaticAberrationShakeEvent);
        }
    }
    ...
    /// </summary>
    public struct MMBeautifyChromaticAberrationShakeEvent_URP
    {
